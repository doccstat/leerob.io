  ...
  return (
    <section>
      ...
      <div className="prose prose-neutral dark:prose-invert">
        ...
        <p>
          The test coverage is 100&#37;. C++ 17 features including the template metaprogramming are used with C++ 14 definition as a fallback based on the compiler version at <a href="https://github.com/doccstat/fastcpd/blob/main/src/constants.h">constants.h</a>.
        </p>
        <p>
