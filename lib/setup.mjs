  ...
  return (
    <section>
      ...
      <div className="flex items-start md:items-center my-8 flex-col md:flex-row">
        ...
        <div className="mt-8 md:mt-0 ml-0 md:ml-6 space-y-2 text-neutral-500 dark:text-neutral-400">
          ...
          <a
            ...
            className="flex items-center gap-2"
          >
            <img src="https://img.shields.io/badge/-Google%20Scholar-0072b1?style=flat&logo=Google%20Scholar&logoColor=white&link=https://scholar.google.com/citations?user=4EXYsLwAAAAJ" alt="Google Scholar Badge" />
          </a>
          <a
            rel="noopener noreferrer"
            target="_blank"
      ...
      <div className="my-8 flex flex-col space-y-4 w-full">
        <Suspense>
          <a
            href="https://openreview.net/forum?id=FAuFpGeLmx"
            className="border border-neutral-200 dark:border-neutral-700 bg-neutral-50  dark:bg-neutral-800 rounded flex items-center justify-between px-3 py-4 w-full"
          >
            <div className="flex flex-col">
              <p className="font-bold text-neutral-900 dark:text-neutral-100">
      ...
      <div className="prose prose-neutral dark:prose-invert">
        <p>
          <ul>
            <li>Ph.D. in Statistics, Texas A&M University, 2020 - 2025 (expected)</li>
