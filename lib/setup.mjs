...
import abseil from 'lib/abseil-r.svg';
  ...
  return (
    <section>
      ...
      <div className="prose prose-neutral dark:prose-invert">
        <p>
          The complete implementation logic of fastcpd is in C++, source code available at <a href="https://github.com/doccstat/fastcpd/tree/main/src">GitHub</a>.
        </p>
        <p>
          The test coverage is 100&#37;. C++ 17 features including the template metaprogramming are used with C++ 14 definition as a fallback based on the compiler version at <a href="https://github.com/doccstat/fastcpd/blob/main/src/fastcpd_constants.h">fastcpd_constants.h</a>.
        </p>
        <p>
          The coding style follows the <a href="https://google.github.io/styleguide/cppguide.html">Google C++ Style Guide</a>.
        </p>
        <p>
      ...
      <ul className="flex flex-col md:flex-row mt-8 space-x-0 md:space-x-4 space-y-2 md:space-y-0 font-sm text-neutral-600 dark:text-neutral-300">
        <li>
          <a
            ...
            rel="noopener noreferrer"
            target="_blank"
            href="https://calendar.google.com/calendar/embed?src=c_4266bb3f9dc3400f7aa1634a9bbfbfcde2e723a4daa57794d7078096b1d4732f%40group.calendar.google.com&ctz=America%2FChicago&mode=WEEK"
          >
            <ArrowIcon />
            <p className="h-7 ml-2">check my work calendar</p>
          </a>
        </li>
        <li>
          <a
